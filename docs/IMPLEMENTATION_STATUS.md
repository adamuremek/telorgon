...
> copies only accumulated output damage. Window-frame inputs reconcile through persistent component
...
> completion path performs no whole-image copy on the input owner. Interactive resize motion is coalesced before protocol
